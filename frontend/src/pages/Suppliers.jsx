      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-end">
            <button type="submit" className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors w-full font-medium shadow-sm">
              + Add Supplier
            </button>
          </div>
        </form>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {displayed.length === 0 && (
              <tr><td colSpan="4" className="p-8 text-center text-gray-500 italic">No suppliers found matching your search.</td></tr>
            )}
          </tbody>
        </table>
      </div>
